...
const services = [
  { icon: FaPhotoVideo, title: 'photography' },
  { icon: FaPersonDressBurst, title: 'modeling' },
  { icon: TbMusicStar, title: 'music' },
  { icon: VscLightbulbSparkle, title: 'skits' },
  { icon: GiMusicSpell, title: 'dance' },
